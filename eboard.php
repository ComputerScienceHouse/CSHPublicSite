		...
		<!--Eboard images should be square and at least 300x300 pixels-->
			...
			<li>
				...
				<span>
					...
					<h3>Gabbie Burns</h3>
					<p>
						&rdquo;Eval&ldquo; is responsible for connecting with the RIT student community, as well as screening, accepting, and orienting new members. Eval is why current members are here today!
						<br/><br/>
			...
			<li>
				...
				<span>
					...
					<p>
						&rdquo;Imps&ldquo; is responsible for keeping our living space respectable and comfortable. The Imps director delegates projects that improve the physical aspects of floor, such as painting, cleaning, building, and organizing House's resources. While we may not be the tidiest group of people, we like to take care of our floor, and it shows.
					</p>
				</span>
			</li>
			...
			<li>
				...
				<span>
					<h2>Social</h2>
					<h3>Michail Yasonik &amp; Benjamin Meyer</h3>
					<p>
