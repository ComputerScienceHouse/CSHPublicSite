...
$(document).ready(() => {
    if ($('#homepage-sponsors').length) {
        const sponsors = [
            ...
            new Sponsor('/assets/images/sponsors/proxmox.png', 'https://proxmox.com/', 'Proxmox'),
            new Sponsor('/assets/images/sponsors/tenable.png', 'https://tenable.com/', 'Tenable'),
            new Sponsor('/assets/images/sponsors/wayfair.png', 'https://wayfair.com/', 'Wayfair'),
            new Sponsor('/assets/images/sponsors/johonnot.png', 'https://johonnottechnologies.com/', 'Johonnot'),
