const content = {
    ...
    'user-center': {
        'title': 'User Center',
        'photos': ['/assets/images/tour/usercenter/1.jpg', '/assets/images/tour/usercenter/2.jpg'],
    ...
    'lounge': {
        'title': 'Lounge',
        'photos': ['/assets/images/tour/lounge/1.jpg', '/assets/images/tour/lounge/2.jpg'],
    ...
    'server-room': {
        'title': 'Server Room',
        'photos': ['/assets/images/tour/server/1.jpg', '/assets/images/tour/server/2.jpg'],
    ...
    'software-room': {
        'title': 'Software Room',
        'photos': ['/assets/images/tour/software/1.jpg', '/assets/images/tour/software/2.jpg'],
    ...
    'research-room': {
        'title': 'Research Room',
        'photos': ['/assets/images/tour/research/1.jpg', '/assets/images/tour/research/2.jpg', '/assets/images/tour/research/3.jpg', '/assets/images/tour/research/4.jpg'],
    ...
    'project-room': {
        'title': 'Project Room',
        'photos': ['/assets/images/tour/project/1.jpg', '/assets/images/tour/project/2.jpg'],
    ...
    'library': {
        'title': 'Library',
        'photos': ['/assets/images/tour/library/1.jpg', '/assets/images/tour/library/2.jpg'],
...
$(document).ready(() => {
    if ($('#tour-page').length) {
        ...
        $('#slider').html(constructSliderHTML(room.photos));
        $('#slider').slick({
            dots: true,
            autoplay: true,
            autoplaySpeed: 5000,
