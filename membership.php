...
<div id="content">
	<p id="aboutp">
		...
		<strong>Member Expectations</strong>
		<br />
	...
	<ul class="memberlist">
		...
		<li>
			Participate in the team-building "Freshman Project" charity event
		</li>
	</ul>
	<br />
	<img id="second" src="images/tour/project2.png" style="margin-left:50px;" />
	<p id="aboutp">
